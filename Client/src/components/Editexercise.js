...
function Editexercise ({ exercise }) {
  ...
  useEffect(() => {
    const editExer = async () => {
      const res = await axios.get(`https://gainz-circuit.herokuapp.com/exercises/${id}`)
      const edit = res.data
      console.log(edit)
    }
  ...
  function handleSubmit (e) {
    ...
    const postUrl = async () => {
      const res = await axios.post(`https://gainz-circuit.herokuapp.com/exercises/update/${id}`, exercise)
      const data = res.data
      console.log(data)
    }
    postUrl()
